...
제공된 그래프는 서비스에 대한 고객 만족도가 전반적으로 매우 낮은 수준임을 보여줍니다. 대부분의 기간 동안 부정 평점이 50%를 넘어서는 '만성적 불만' 상태가 지속되고 있습니다.


![분기별](https://github.com/user-attachments/assets/9a4d922c-75e2-43a1-b49e-4b843e2ab7ab)

이런 결과가 나온 이유는 본 스포티파이 리뷰가 구글플레이어의 리뷰를 인용한것으로 보인다. 구글 플레이어는 다양한 국가의 사람들이 리뷰를 남기는데, 국내 사용자 30%만이 긍정적인 의견을 보인데 반해, 
미국 사용자들의 69%가 긍정적인 의견을 보여 상반된 양상을  보이고  있다. 이로 인하여 부정 리뷰가 많아보이는 환각 작용이 나타난것으로 보인다.
